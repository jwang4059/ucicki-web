	...
	return (
		<Layout>
			...
			<div className="max-w-7xl mx-auto">
				<h1 className="p-6 text-center text-3xl font-extrabold">Fellowship</h1>
				<article className="grid gap-4 p-6">
					<h2 className="text-xl font-bold">What is Fellowship?</h2>
					<p>
					...
					<p>
						...
						(and returning) littles settle into their new families, the bigs of
						each family plan out social events as well as encourage
						participation in the club-wide events. For many members, this system
						has fostered long-term relationships and provided a welcoming
						support system for everyone.
					</p>
					<p>
						For those that are excited to meet more people in Circle K, the
						mentor-mentee program pairs new Circle K members with older Circle K
						members. This allows newer members to learn more about what Circle K
						has to offer them while bonding with their mentors.
					</p>
					<p>
						Throughout the year, UCI Circle K plans many club-wide events, big
						and small, to promote a strong sense of companionship and the tight
						bond that each member will experience during their time in the club
						(which will hopefully transfer into their time at UCI) ;)
					</p>
				</article>
				<article className="grid gap-4 p-6">
					...
					<EventCard
						title="Snocial"
						subheading="Big Bear Lake | Club Event"
					...
					<EventCard
						title="Family Day"
						subheading="Mason Park / Corona Del Mar | Club Event"
				...
				<article className="p-6">
					...
					<p className="mb-8">
						...
						Downtown Disney. During finals week of every quarter, Green Thrones
						(@ UCI Student Center) welcomes all members who need a quiet place
						to study as well as to take a break from finals in general. Whether
						you’re feeling tuckered out from studying or just wanting to release
						some steam, go to these events and possibly meet someone new from
						Circle K; who knows?
					</p>
				...
				<article className="p-6">
					<h2 className="mb-2 text-center text-xl font-bold">Collab Socials</h2>
					<p className="mb-8">
						...
						district. Besides, it wouldn't hurt to say hi or socialize with our
						fellow non-UCI Kiwanians once in a while right? There aren't many
						opportunities outside of DCON and TCs that we get to interact with
						members outside of UCI. Thus, there are collab socials! Just like
						the socials that are held for UCI CKI members, these collab socials
						are sometimes bigger but offer the same amount of fun and quality
						time. Whether it's munching on delicious donuts at Seaside Bakery or
						enjoying a cold ice cream cone at Afters, you still get to bond with
						the people around you. So, if you can’t make it to DCON or the TCs
						and still want to meet new people within the district, give these
						socials a go! :D
					</p>
					<div className="grid gap-4 md:grid-cols-2">
						<EventCard
							title="UCICKI Visits..."
							subheading="Orange Coast College and Others | Club Event"
